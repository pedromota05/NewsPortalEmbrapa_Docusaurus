    ...
    <>
      <div className='container'>
        <div className='card-container'>
            <div className='card'> {/* Altere para item._id */}
                <img className="card-img" src="https://www.embrapa.br/image/journal/article?img_id=82594655&t=1691173359654&width=255" alt="Imagem" />
                <span className="card-description">07/07/2023</span>
                <p className="card-title">Itaipu Binacional e Embrapa pedem apoio da comunidade para desenvolver pesquisa em água e solo</p>
                <a href="https://www.embrapa.br/agropecuaria-oeste" className="card-link">Saiba Mais</a>
            </div>
            <div className='card'> {/* Altere para item._id */}
                <img className="card-img" src="https://www.embrapa.br/image/journal/article?img_id=81665706&t=1689084043398&width=255" alt="Imagem" />
                <span className="card-description">05/07/2023</span>
                <p className="card-title">Artigo - A evolução da agricultura do Brasil</p>
                <a href="https://www.embrapa.br/agropecuaria-oeste" className="card-link">Saiba Mais</a>
            </div>
            <div className='card'> {/* Altere para item._id */}
                <img className="card-img" src="https://www.embrapa.br/image/journal/article?img_id=81609145&t=1689084049102&width=255" alt="Imagem" />
                <span className="card-description">03/07/2023</span>
                <p className="card-title">Tecnologias para a Intensificação Sustentável da Produção Agropecuária em debate no II SIP</p>
                <a href="https://www.embrapa.br/agropecuaria-oeste" className="card-link">Saiba Mais</a>
            </div>
            <div className='card'> {/* Altere para item._id */}
                <img className="card-img" src="https://www.embrapa.br/image/journal/article?img_id=81609481&t=1689084047583&width=255" alt="Imagem" />
                <span className="card-description">03/07/2023</span>
                <p className="card-title">Artigo: Parcerias que fazem a diferença</p>
                <a href="https://www.embrapa.br/agropecuaria-oeste" className="card-link">Saiba Mais</a>
            </div>
            <div className='card'> {/* Altere para item._id */}
                <img className="card-img" src="https://i.ytimg.com/vi/posgCHl23-0/maxresdefault.jpg" alt="Imagem" />
                <span className="card-description">29/06/2023</span>
                <p className="card-title">SIP 2023 - Simpósio sobre Sistemas Intensivos de Produção | Michely Tomazi</p>
                <a href="https://www.embrapa.br/agropecuaria-oeste" className="card-link">Saiba Mais</a>
            </div>
            <div className='card'> {/* Altere para item._id */}
                <img className="card-img" src="https://i.ytimg.com/vi/1vOp2jrq0E4/maxresdefault.jpg" alt="Imagem" />
                <span className="card-description">07/06/2023</span>
                <p className="card-title">SIP 2023 - Simpósio sobre Sistemas Intensivos de Produção | Rodrigo Arroyo Garcia"</p>
                <a href="https://www.embrapa.br/agropecuaria-oeste" className="card-link">Saiba Mais</a>
            </div>
        </div>
      </div>
...
//   const response = await axios.get('https://apirestembrapa--pedromota05.repl.co/api/services');
//   const data = await JSON.parse(response.data); // Fazer o parsing da string JSON
